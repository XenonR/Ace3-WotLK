...
local function SetTextureDesaturated(texture, desaturated)
	if texture.SetDesaturated then
		...
		SetDesaturation(texture, desaturated)
	end
end
...
do
	...
	local function SetDisabled(self, disabled) -- Disable the widget.
		...
		if disabled then
			self.frame:Disable()
			SetTextureDesaturated(self.speaker, true)
			SetTextureDesaturated(self.speakeron, true)
		else
			self.frame:Enable()
			SetTextureDesaturated(self.speaker, false)
			SetTextureDesaturated(self.speakeron, false)
		end
	end
