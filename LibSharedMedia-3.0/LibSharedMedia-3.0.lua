...
local MAJOR, MINOR = "LibSharedMedia-3.0", 8020004 -- 8.2.0 v3 / increase manually on changes
...
local bit_band		= _G.bit and _G.bit.band
local table_sort	= _G.table.sort

local RESTRICTED_FILE_ACCESS = _G.WOW_PROJECT_ID and _G.WOW_PROJECT_MAINLINE and _G.WOW_PROJECT_ID == _G.WOW_PROJECT_MAINLINE -- starting with 8.2, some rules for file access have changed; classic still uses the old way
